...
-- Table for purchased items (cart) 
...
-- Relationship between classification and cart
...
-- Relationship between account and cart
ALTER TABLE IF EXISTS public.cart
...
-- Relationship between inventory and cart
ALTER TABLE IF EXISTS public.cart
